...
- **`pi-codes`** — currently `pi-codes 0.86.0`, tested against pi `0.86.0` (`@earendil-works/pi-coding-agent`; live tier: credential-free RPC surface + model turns and tool conformance when a provider key is present).
